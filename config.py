...
# Routing & Retrieval
# Routing & Retrieval
ROUTING_PRIMARY_K = 15     # Candidates from predicted namespace (Increased to avoid missing drugs)
ROUTING_SECONDARY_K = 4     # Candidates from other namespaces (fallback)
